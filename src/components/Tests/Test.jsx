...
const Test = (props) => {
  ...
  const testScriptConditionalRender = () => {
    switch(props.testScriptPosition){
      ...
      case 7:
        return(<MemoryTest memoryItems='3' id='1'/>);
      case 8:
        return(<MemoryTest memoryItems='4' id='2'/>);
      case 9:
        return(<MemoryTest memoryItems='5' id='3'/>);
      case 10:
        return(<MemoryTest memoryItems='6' id='4'/>);
      case 11:
        return(<MemoryTest memoryItems='7' id='5'/>);
      case 12:
        return(<MemoryTest memoryItems='8' id='6'/>);
      case 13:
        return(<MemoryTest memoryItems='9' id='7'/>);
      case 14:
        return(<MemoryTest memoryItems='10' id='8'/>);
        case 15:
